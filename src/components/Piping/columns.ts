...
export const takeOffColumns: ColumnDef<FefRow, string>[] = [
  ...
  columnHelper.display({ id: "unitHours", header: "Unit Rate (HRS)", cell: UnitHoursCell, size: 110 }),
  ...
  columnHelper.display({ id: "unitRate", header: "Unit Rate ($)", cell: UnitRateCell, size: 110 }),
