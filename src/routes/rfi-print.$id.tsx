...
/**
 * Printable single-RFI detail view. Mirrors `/cvr-print/$id` and
 * `/fco-print/$id`. Toolbar visible on screen; `@media print` rules in
 * `app.css` hide the app chrome so the printed PDF contains only the
 * document itself.
 *
 * Sections are RFI-specific: question, references, response. Signature
 * blocks for originator + responder rather than approvers.
 */
